    ...
    for iteration in range(1, max_iterations + 1):
        ...
        for tc in tool_calls:
            ...
            try:
                ...
                tool_result = await mcp_tools.execute(tool_name, tool_args, agent_name=agent_name, user_id=user_id)
...
def _build_user_content(message: str, context: dict | None) -> str:
    ...
    FASE 17: Delimiters ### para separar seções de contexto (17.4).
    Contexto injetado ANTES da mensagem do usuário — LLM lê do topo.
    """
    parts = []
    ...
    if context:
        ...
        # FASE 17: ### delimiters para clareza de contexto
        if identity_parts:
        ...
        # FASE 0 #1: Inject ToT pre-reasoning generated by agent.think()
        ...
        # FASE 17: Separator before actual user question (17.4 — output primer boundary)
        if parts:
            parts.append("---")
